...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%', background: '#06060a', borderRadius: 20, padding: 30, fontFamily: 'Inter, sans-serif', position: 'relative', overflow: 'hidden', border: '1px solid rgba(110,80,220,0.2)' }}>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', zIndex: 10, gap: 4 }}>
    <span style={{ fontSize: 64, fontWeight: 700, color: '#ffffff', letterSpacing: 10 }}>6jt8</span>
    <span style={{ fontSize: 14, color: '#6a6a8a', fontWeight: 400, letterSpacing: 4, textTransform: 'uppercase', marginTop: 2 }}>Fullstack Systems Developer</span>
    <span style={{ fontSize: 12, color: '#4a4a6a', fontWeight: 400, letterSpacing: 1.5, marginTop: 6 }}>Building clean tools  •  Automating workflows  •  Ship small projects</span>
  </div>
  <div style={{ display: 'flex', gap: 8, marginTop: 22, zIndex: 10 }}>
    <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '#3178c6', borderRadius: 14, fontSize: 12, fontWeight: 700, border: '1px solid rgba(49,120,198,0.3)', letterSpacing: 1 }}>TypeScript</span>
    <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '#3572A5', borderRadius: 14, fontSize: 12, fontWeight: 700, border: '1px solid rgba(53,114,165,0.3)', letterSpacing: 1 }}>Python</span>
    <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '#178600', borderRadius: 14, fontSize: 12, fontWeight: 700, border: '1px solid rgba(23,134,0,0.3)', letterSpacing: 1 }}>C#</span>
    <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '#dea584', borderRadius: 14, fontSize: 12, fontWeight: 700, border: '1px solid rgba(222,165,132,0.3)', letterSpacing: 1 }}>Rust</span>
  </div>
</div>
```
...
<div style={{ display: 'flex', width: '100%', height: '100%', gap: 14, fontFamily: 'Inter, sans-serif', position: 'relative', overflow: 'hidden', background: '#06060a', borderRadius: 18, padding: 20, border: '1px solid rgba(110,80,220,0.15)' }}>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', flex: 1, background: 'rgba(10,8,18,0.7)', borderRadius: 14, padding: 22, border: '1px solid rgba(100,70,200,0.18)', zIndex: 10, justifyContent: 'center' }}>
    ...
    <span style={{ fontSize: 15, fontWeight: 700, color: '#ffffff', marginBottom: 6 }}>Fullstack Developer</span>
    <span style={{ fontSize: 12, color: 'rgba(200,200,230,0.8)', lineHeight: 1.5 }}>Building clean tools, automating workflows, and shipping small projects. TypeScript, Python, C#, Rust.</span>
  </div>
  <div style={{ display: 'flex', flexDirection: 'column', flex: 1, background: 'rgba(10,8,18,0.7)', borderRadius: 14, padding: 22, border: '1px solid rgba(100,70,200,0.18)', zIndex: 10, justifyContent: 'center' }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <span style={{ fontSize: 13, color: '#e0e0f0', fontWeight: 400 }}>DC-Lyra Discord music bot</span>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <span style={{ fontSize: 13, color: '#e0e0f0', fontWeight: 400 }}>devinspire README quotes</span>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <span style={{ fontSize: 13, color: '#e0e0f0', fontWeight: 400 }}>nightcord Discord utilities</span>
      </div>
    </div>
  </div>
</div>
...
<div style={{ display: 'flex', gap: 10, padding: '14px 22px', width: '100%', height: '100%', background: '#06060a', borderRadius: 30, alignItems: 'center', justifyContent: 'center', fontFamily: 'Inter, sans-serif', position: 'relative', overflow: 'hidden', border: '1px solid rgba(110,80,220,0.15)' }}>
  ...
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '#3178c6', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid rgba(49,120,198,0.3)', zIndex: 10 }}>TypeScript</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '#3572A5', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid rgba(53,114,165,0.3)', zIndex: 10 }}>Python</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '#178600', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid rgba(23,134,0,0.3)', zIndex: 10 }}>C#</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '#dea584', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid rgba(222,165,132,0.3)', zIndex: 10 }}>Rust</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '#ff3e00', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid rgba(255,62,0,0.3)', zIndex: 10 }}>Svelte</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '#f1e05a', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid rgba(241,224,90,0.3)', zIndex: 10 }}>JavaScript</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '#e34c26', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid rgba(227,76,38,0.3)', zIndex: 10 }}>HTML</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '#663399', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid rgba(102,51,153,0.3)', zIndex: 10 }}>CSS</span>
</div>
```
...
```aura width=800 height=185 link="https://github.com/6jt8"
<div style={{ display: 'flex', width: '100%', height: '100%', gap: 12, fontFamily: 'Inter, sans-serif', position: 'relative', overflow: 'hidden', background: '#06060a', borderRadius: 16, padding: 18, border: '1px solid rgba(110,80,220,0.15)' }}>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', flex: 1, background: 'rgba(10,8,18,0.7)', borderRadius: 14, padding: 18, border: '1px solid rgba(120,200,255,0.12)', zIndex: 10, justifyContent: 'center' }}>
    <span style={{ fontSize: 17, fontWeight: 700, color: '#ffffff', marginBottom: 4 }}>DC-Lyra</span>
    <span style={{ fontSize: 11, color: '#7ee7ff', marginBottom: 6, fontWeight: 700, letterSpacing: 0.5 }}>Discord Music Bot</span>
    <span style={{ fontSize: 11, color: 'rgba(200,200,230,0.75)', lineHeight: 1.4, marginBottom: 10 }}>A modern, modular Discord music bot with high-quality Lavalink audio and custom queue management</span>
    <div style={{ display: 'flex', gap: 5 }}>
      <span style={{ padding: '2px 10px', background: 'rgba(49,120,198,0.08)', color: '#3178c6', borderRadius: 8, fontSize: 10, fontWeight: 700, border: '1px solid rgba(49,120,198,0.15)' }}>TypeScript</span>
    </div>
  </div>
  <div style={{ display: 'flex', flexDirection: 'column', flex: 1, background: 'rgba(10,8,18,0.7)', borderRadius: 14, padding: 18, border: '1px solid rgba(200,120,255,0.12)', zIndex: 10, justifyContent: 'center' }}>
    <span style={{ fontSize: 17, fontWeight: 700, color: '#ffffff', marginBottom: 4 }}>devinspire</span>
    <span style={{ fontSize: 11, color: '#e8c8ff', marginBottom: 6, fontWeight: 700, letterSpacing: 0.5 }}>Dev Quotes for README</span>
    <span style={{ fontSize: 11, color: 'rgba(200,200,230,0.75)', lineHeight: 1.4, marginBottom: 10 }}>Spice up your GitHub README with random dev quotes. Custom styles, dynamic content, easy integration.</span>
    <div style={{ display: 'flex', gap: 5 }}>
      <span style={{ padding: '2px 10px', background: 'rgba(241,224,90,0.08)', color: '#f1e05a', borderRadius: 8, fontSize: 10, fontWeight: 700, border: '1px solid rgba(241,224,90,0.15)' }}>JavaScript</span>
    </div>
  </div>
  <div style={{ display: 'flex', flexDirection: 'column', flex: 1, background: 'rgba(10,8,18,0.7)', borderRadius: 14, padding: 18, border: '1px solid rgba(255,100,180,0.12)', zIndex: 10, justifyContent: 'center' }}>
    <span style={{ fontSize: 17, fontWeight: 700, color: '#ffffff', marginBottom: 4 }}>nightcord</span>
    <span style={{ fontSize: 11, color: '#ff88cc', marginBottom: 6, fontWeight: 700, letterSpacing: 0.5 }}>Discord Utilities</span>
    <span style={{ fontSize: 11, color: 'rgba(200,200,230,0.75)', lineHeight: 1.4, marginBottom: 10 }}>Everything Discord doesn't build, we create. Custom Discord tools and utilities for server management.</span>
    <div style={{ display: 'flex', gap: 5 }}>
      <span style={{ padding: '2px 10px', background: 'rgba(49,120,198,0.08)', color: '#3178c6', borderRadius: 8, fontSize: 10, fontWeight: 700, border: '1px solid rgba(49,120,198,0.15)' }}>TypeScript</span>
    </div>
  </div>
