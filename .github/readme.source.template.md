...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%', background: '#06060a', borderRadius: 20, padding: 30, fontFamily: 'Inter, sans-serif', position: 'relative', overflow: 'hidden', border: '1px solid rgba(110,80,220,0.2)' }}>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', zIndex: 10, gap: 4 }}>
    <span style={{ fontSize: 64, fontWeight: 700, color: '#ffffff', letterSpacing: 10 }}>{{HERO_NAME}}</span>
    <span style={{ fontSize: 14, color: '#6a6a8a', fontWeight: 400, letterSpacing: 4, textTransform: 'uppercase', marginTop: 2 }}>{{HERO_TITLE}}</span>
    <span style={{ fontSize: 12, color: '#4a4a6a', fontWeight: 400, letterSpacing: 1.5, marginTop: 6 }}>{{HERO_TAGLINE}}</span>
  </div>
  <div style={{ display: 'flex', gap: 8, marginTop: 22, zIndex: 10 }}>
    <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '{{HERO_TAG_0_COLOR}}', borderRadius: 14, fontSize: 12, fontWeight: 700, border: '1px solid {{BORDER:HERO_TAG_0_COLOR:0.3}}', letterSpacing: 1 }}>{{HERO_TAG_0_LABEL}}</span>
    <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '{{HERO_TAG_1_COLOR}}', borderRadius: 14, fontSize: 12, fontWeight: 700, border: '1px solid {{BORDER:HERO_TAG_1_COLOR:0.3}}', letterSpacing: 1 }}>{{HERO_TAG_1_LABEL}}</span>
    <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '{{HERO_TAG_2_COLOR}}', borderRadius: 14, fontSize: 12, fontWeight: 700, border: '1px solid {{BORDER:HERO_TAG_2_COLOR:0.3}}', letterSpacing: 1 }}>{{HERO_TAG_2_LABEL}}</span>
    <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '{{HERO_TAG_3_COLOR}}', borderRadius: 14, fontSize: 12, fontWeight: 700, border: '1px solid {{BORDER:HERO_TAG_3_COLOR:0.3}}', letterSpacing: 1 }}>{{HERO_TAG_3_LABEL}}</span>
  </div>
</div>
```
...
<div style={{ display: 'flex', width: '100%', height: '100%', gap: 14, fontFamily: 'Inter, sans-serif', position: 'relative', overflow: 'hidden', background: '#06060a', borderRadius: 18, padding: 20, border: '1px solid rgba(110,80,220,0.15)' }}>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', flex: 1, background: 'rgba(10,8,18,0.7)', borderRadius: 14, padding: 22, border: '1px solid rgba(100,70,200,0.18)', zIndex: 10, justifyContent: 'center' }}>
    <span style={{ fontSize: 10, color: 'rgba(120,200,255,0.7)', textTransform: 'uppercase', letterSpacing: 3, marginBottom: 10, fontWeight: 700 }}>Profile</span>
    <span style={{ fontSize: 15, fontWeight: 700, color: '#ffffff', marginBottom: 6 }}>{{PROFILE_HEADING}}</span>
    <span style={{ fontSize: 12, color: 'rgba(200,200,230,0.8)', lineHeight: 1.5 }}>{{PROFILE_DESCRIPTION}}</span>
  </div>
  <div style={{ display: 'flex', flexDirection: 'column', flex: 1, background: 'rgba(10,8,18,0.7)', borderRadius: 14, padding: 22, border: '1px solid rgba(100,70,200,0.18)', zIndex: 10, justifyContent: 'center' }}>
    <span style={{ fontSize: 10, color: 'rgba(200,120,255,0.7)', textTransform: 'uppercase', letterSpacing: 3, marginBottom: 10, fontWeight: 700 }}>Experience</span>
    <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <span style={{ fontSize: 13, color: '#e0e0f0', fontWeight: 400 }}>{{EXPERIENCE_0}}</span>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <span style={{ fontSize: 13, color: '#e0e0f0', fontWeight: 400 }}>{{EXPERIENCE_1}}</span>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <span style={{ fontSize: 13, color: '#e0e0f0', fontWeight: 400 }}>{{EXPERIENCE_2}}</span>
      </div>
    </div>
  </div>
</div>
...
<div style={{ display: 'flex', gap: 10, padding: '14px 22px', width: '100%', height: '100%', background: '#06060a', borderRadius: 30, alignItems: 'center', justifyContent: 'center', fontFamily: 'Inter, sans-serif', position: 'relative', overflow: 'hidden', border: '1px solid rgba(110,80,220,0.15)' }}>
  ...
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '{{TECH_0_COLOR}}', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid {{BORDER:TECH_0_COLOR:0.3}}', zIndex: 10 }}>{{TECH_0_LABEL}}</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '{{TECH_1_COLOR}}', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid {{BORDER:TECH_1_COLOR:0.3}}', zIndex: 10 }}>{{TECH_1_LABEL}}</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '{{TECH_2_COLOR}}', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid {{BORDER:TECH_2_COLOR:0.3}}', zIndex: 10 }}>{{TECH_2_LABEL}}</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '{{TECH_3_COLOR}}', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid {{BORDER:TECH_3_COLOR:0.3}}', zIndex: 10 }}>{{TECH_3_LABEL}}</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '{{TECH_4_COLOR}}', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid {{BORDER:TECH_4_COLOR:0.3}}', zIndex: 10 }}>{{TECH_4_LABEL}}</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '{{TECH_5_COLOR}}', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid {{BORDER:TECH_5_COLOR:0.3}}', zIndex: 10 }}>{{TECH_5_LABEL}}</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '{{TECH_6_COLOR}}', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid {{BORDER:TECH_6_COLOR:0.3}}', zIndex: 10 }}>{{TECH_6_LABEL}}</span>
  <span style={{ padding: '5px 16px', background: 'rgba(8,6,14,0.7)', color: '{{TECH_7_COLOR}}', borderRadius: 16, fontSize: 13, fontWeight: 700, border: '1px solid {{BORDER:TECH_7_COLOR:0.3}}', zIndex: 10 }}>{{TECH_7_LABEL}}</span>
</div>
```
...
<div style={{ display: 'flex', width: '100%', height: '100%', gap: 12, fontFamily: 'Inter, sans-serif', position: 'relative', overflow: 'hidden', background: '#06060a', borderRadius: 16, padding: 18, border: '1px solid rgba(110,80,220,0.15)', alignItems: 'center', justifyContent: 'center' }}>
  ...
  <div style={{ display: 'flex', gap: 30, alignItems: 'center', zIndex: 10 }}>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
      <span style={{ fontSize: 24, fontWeight: 700, color: '#ffffff' }}>{github?.stats?.totalStars ?? 0}</span>
      <span style={{ fontSize: 10, color: '#b8860b', textTransform: 'uppercase', letterSpacing: 2, fontWeight: 700 }}>Stars</span>
    </div>
    <span style={{ width: 1, height: 40, background: 'rgba(120,80,220,0.2)' }}></span>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
      <span style={{ fontSize: 24, fontWeight: 700, color: '#ffffff' }}>{github?.stats?.totalForks ?? 0}</span>
      <span style={{ fontSize: 10, color: '#8b7ec8', textTransform: 'uppercase', letterSpacing: 2, fontWeight: 700 }}>Forks</span>
    </div>
    <span style={{ width: 1, height: 40, background: 'rgba(120,80,220,0.2)' }}></span>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
      <span style={{ fontSize: 24, fontWeight: 700, color: '#ffffff' }}>{github?.stats?.totalRepos ?? 0}</span>
      <span style={{ fontSize: 10, color: '#5a9ca8', textTransform: 'uppercase', letterSpacing: 2, fontWeight: 700 }}>Repos</span>
    </div>
    <span style={{ width: 1, height: 40, background: 'rgba(120,80,220,0.2)' }}></span>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
      <span style={{ fontSize: 24, fontWeight: 700, color: '#ffffff' }}>{github?.stats?.totalCommits ?? 0}</span>
      <span style={{ fontSize: 10, color: '#7ee7ff', textTransform: 'uppercase', letterSpacing: 2, fontWeight: 700 }}>Commits</span>
    </div>
  </div>
</div>
```
...
<div style={{ display: 'flex', flexDirection: 'column', width: '100%', height: '100%', fontFamily: 'Inter, sans-serif', position: 'relative', overflow: 'hidden', background: '#06060a', borderRadius: 16, padding: 24, border: '1px solid rgba(110,80,220,0.15)' }}>
  ...
  <span style={{ fontSize: 10, color: 'rgba(120,200,255,0.7)', textTransform: 'uppercase', letterSpacing: 3, marginBottom: 16, fontWeight: 700, zIndex: 10 }}>Most Used Languages</span>
  ...
  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 14, zIndex: 10 }}>
    {(github?.languages ?? []).map((lang, i) => (
      <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 6, minWidth: 120 }}>
        ...
        <span style={{ fontSize: 13, color: '#e0e0f0', fontWeight: 400 }}>{lang.name}</span>
...
```aura width=800 height=185 link="{{PROFILE_URL}}"
<div style={{ display: 'flex', width: '100%', height: '100%', gap: 12, fontFamily: 'Inter, sans-serif', position: 'relative', overflow: 'hidden', background: '#06060a', borderRadius: 16, padding: 18, border: '1px solid rgba(110,80,220,0.15)' }}>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', flex: 1, background: 'rgba(10,8,18,0.7)', borderRadius: 14, padding: 18, border: '1px solid rgba(120,200,255,0.12)', zIndex: 10, justifyContent: 'center' }}>
    <span style={{ fontSize: 17, fontWeight: 700, color: '#ffffff', marginBottom: 4 }}>{{PROJECT_0_NAME}}</span>
    <span style={{ fontSize: 11, color: '#7ee7ff', marginBottom: 6, fontWeight: 700, letterSpacing: 0.5 }}>{{PROJECT_0_SUBTITLE}}</span>
    <span style={{ fontSize: 11, color: 'rgba(200,200,230,0.75)', lineHeight: 1.4, marginBottom: 10 }}>{{PROJECT_0_DESC}}</span>
    <div style={{ display: 'flex', gap: 5 }}>
      <span style={{ padding: '2px 10px', background: '{{BORDER:PROJECT_0_TAG_0_COLOR:0.08}}', color: '{{PROJECT_0_TAG_0_COLOR_LIGHT}}', borderRadius: 8, fontSize: 10, fontWeight: 700, border: '1px solid {{BORDER:PROJECT_0_TAG_0_COLOR:0.15}}' }}>{{PROJECT_0_TAG_0_LABEL}}</span>
    </div>
  </div>
  <div style={{ display: 'flex', flexDirection: 'column', flex: 1, background: 'rgba(10,8,18,0.7)', borderRadius: 14, padding: 18, border: '1px solid rgba(200,120,255,0.12)', zIndex: 10, justifyContent: 'center' }}>
    <span style={{ fontSize: 17, fontWeight: 700, color: '#ffffff', marginBottom: 4 }}>{{PROJECT_1_NAME}}</span>
    <span style={{ fontSize: 11, color: '#e8c8ff', marginBottom: 6, fontWeight: 700, letterSpacing: 0.5 }}>{{PROJECT_1_SUBTITLE}}</span>
    <span style={{ fontSize: 11, color: 'rgba(200,200,230,0.75)', lineHeight: 1.4, marginBottom: 10 }}>{{PROJECT_1_DESC}}</span>
    <div style={{ display: 'flex', gap: 5 }}>
      <span style={{ padding: '2px 10px', background: '{{BORDER:PROJECT_1_TAG_0_COLOR:0.08}}', color: '{{PROJECT_1_TAG_0_COLOR_LIGHT}}', borderRadius: 8, fontSize: 10, fontWeight: 700, border: '1px solid {{BORDER:PROJECT_1_TAG_0_COLOR:0.15}}' }}>{{PROJECT_1_TAG_0_LABEL}}</span>
    </div>
  </div>
  <div style={{ display: 'flex', flexDirection: 'column', flex: 1, background: 'rgba(10,8,18,0.7)', borderRadius: 14, padding: 18, border: '1px solid rgba(255,100,180,0.12)', zIndex: 10, justifyContent: 'center' }}>
    <span style={{ fontSize: 17, fontWeight: 700, color: '#ffffff', marginBottom: 4 }}>{{PROJECT_2_NAME}}</span>
    <span style={{ fontSize: 11, color: '#ff88cc', marginBottom: 6, fontWeight: 700, letterSpacing: 0.5 }}>{{PROJECT_2_SUBTITLE}}</span>
    <span style={{ fontSize: 11, color: 'rgba(200,200,230,0.75)', lineHeight: 1.4, marginBottom: 10 }}>{{PROJECT_2_DESC}}</span>
    <div style={{ display: 'flex', gap: 5 }}>
      <span style={{ padding: '2px 10px', background: '{{BORDER:PROJECT_2_TAG_0_COLOR:0.08}}', color: '{{PROJECT_2_TAG_0_COLOR_LIGHT}}', borderRadius: 8, fontSize: 10, fontWeight: 700, border: '1px solid {{BORDER:PROJECT_2_TAG_0_COLOR:0.15}}' }}>{{PROJECT_2_TAG_0_LABEL}}</span>
    </div>
  </div>
</div>
```
...
<!-- PROFILE_MODE -->
<p align="center">
  <img src="https://komarev.com/ghpvc/?username={{HERO_NAME}}&label=Profile%20views&color=0e75b6&style=flat" alt="{{HERO_NAME}}" />
</p>

<p align="center">
  <img src="./.github/assets/profile.svg" alt="{{HERO_NAME}}'s Profile" />
</p>
<!-- END_PROFILE_MODE -->
